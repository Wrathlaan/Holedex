...
export const UNOVA_POKEMON: Pokemon[] = [
  ...
  { id: 642, name: 'thundurus-incarnate', types: ['electric', 'flying'] },
  { id: 643, name: 'reshiram', types: ['dragon', 'fire'] },
  { id: 644, name: 'zekrom', types: ['dragon', 'electric'] },
  { id: 645, name: 'landorus-incarnate', types: ['ground', 'flying'] },
  { id: 646, name: 'kyurem', types: ['dragon', 'ice'] },
  { id: 647, name: 'keldeo-ordinary', types: ['water', 'fighting'] },
